...
let
  ...
  mkUserJs =
    prePrefs: prefs: extraPrefs: bookmarks: extensions:
    let
      prefs' =
                  ...
                  type = types.attrsOf (
                    types.submodule {
                      options = {
                        settings = mkOption {
                          type = types.attrsOf jsonFormat.type;
                          description = "Json formatted options for the specified plugin";
                        };
                      };
                    }
                  );
            ...
            [
              {
                ...
                "${profilesPath}/${profile.path}/user.js" =
                  mkIf
                    ...
                    {
                      text =
                        mkUserJs profile.preConfig profile.settings profile.extraConfig profile.bookmarks
